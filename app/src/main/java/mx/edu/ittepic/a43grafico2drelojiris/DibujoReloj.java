package mx.edu.ittepic.a43grafico2drelojiris;
...
public class DibujoReloj extends View {
    ...
    public DibujoReloj(Context context) {
        super(context);
    }

    public DibujoReloj(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DibujoReloj(Context context, AttributeSet attrs, int defStyleAttr) {
